...
2. [Specifying custom rules](https://github.com/terraform-aws-modules/terraform-aws-security-group#security-group-with-custom-rules)
...
| tags | A mapping of tags to assign to security group | map | - | yes |
...
| use_prefix | Whether to use environment prefix from tags | string | `true` | no |
