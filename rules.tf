variable "rules" {
  ...
  default = {
    ...
    # Jupyter NoteBook
    jupyter-8899-tcp = [8899, 8899, "tcp", "Jupyter Notebook port"]
    # Rstudio Server
    rstudio-8787-tcp = [8787, 8787, "tcp", "Jupyter Notebook port"]
...
variable "auto_groups" {
  ...
  default = {
    ...
    jupyter = {
      ingress_rules     = ["jupyter-8899-tcp"]
      ingress_with_self = ["all-all"]
      egress_rules      = ["all-all"]
    }
    rstudio = {
      ingress_rules     = ["rstudio-8787-tcp"]
      ingress_with_self = ["all-all"]
      egress_rules      = ["all-all"]
    }
  }
